...
class _DailyChallengeScreenState extends ConsumerState<DailyChallengeScreen> {
  ...
  void initState() {
    super.initState();
    _questions = (widget.challenge['questions'] as List<dynamic>? ?? [])
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: LinearProgressIndicator(
                  ...
                  valueColor:
                      const AlwaysStoppedAnimation(SwarajColors.saffron),
                ),
              ),
            ],
          ),
              ...
              children: [
                ...
                ...options.asMap().entries.map((entry) {
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: () => setState(() => _answers[qId] = optText),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: SwarajColors.success.withValues(alpha: 0.3)),
            ),
            child: Row(
              children: [
