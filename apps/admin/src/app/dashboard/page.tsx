      ...
      <section className="rounded-lg border border-[#e8e1d6] bg-white p-6 shadow-soft">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-slate-600">Live view of civic learning progress across Rajasthan schools.</p>
          </div>
          <div className="grid grid-cols-2 gap-3 sm:flex">
            ...
            <div className="rounded-lg border border-[#eadfce] bg-[#fbfaf6] px-4 py-3">
              ...
              <p className="mt-1 text-sm font-bold text-navy">School Admin</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Highest current student participation</p>
            </div>
